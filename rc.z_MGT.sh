...
<vbox>
	...
	<vbox>
      <button  height-request="39"  size="xx-large"  weight="bold" tooltip-text="Frame-Title Manager+ReStart 
       This is LINUX, 
...
<vbox>
<vbox>
		<button label="'---*---'" visible="false"  tooltip-text="*'workingC4-C4-C4-C4-C4'*"    has-focus="false" height-request="17" width-request="35" space-expand="false" > 
        ...
        <button visible="0"has-focus="false" height-request="10"  xalign=".5"  tooltip-text="OS_ID_Save" >
    ...
    <vbox>
       ...
       <button visible="0" has-focus="false" width-request="10" height-request="5"  xalign=".5"   tooltip-text="visible-Half-Line" >
		...
		<button label="'===-E3R-Tools-==='"
            visible="true" 		has-focus="false" height-request="29" use-stock="true"
            tooltip-text="
...
<button visible="false" tooltip-text="##################################################" ><label>""</label><action>'EXIT:xxx'</action></button>
	...
	E3R +S2F +pMnt +CTA-SL +uMnt,   .
	+'ReBOOT' system {!}" >
			<input file>"/tmp/EmGr-img-jug-grnxorange.svg"</input><width>27</width><height>27</height>
			<label> '!!_E3R+CTB+ReBoot_!!_' </label>
                <action function="'launch'">msg_DC_NoShow_window</action><action function="'closewindow'">msg_DC_NoShow_window</action>
...
<button visible="false" tooltip-text="##################################################" ><label>""</label><action>'EXIT:xxx'</action></button>
	...
	+ 'PowerOff' system {!}">
			...
			<label> '!!!_E3R+CTB+PowerOff_!!!_' </label>
                <action function="'launch'">msg_DC_NoShow_window</action><action function="'closewindow'">msg_DC_NoShow_window</action>
...
<hbox>
       <hseparator visible="1"  tooltip-text="* Not-VISIBLE *" label="Not Showing Text" width-request="120"></hseparator>
       ...
       <hseparator visible="1"  tooltip-text="* Not-VISIBLE *" label="Not Showing Text" width-request="190"></hseparator>
