#!/bin/bash
#!
#!   Location of this MGR file.sh
#!  /initrd/mnt/dev_save/MY_/usr-share/My_Dev_/Edit_MGR/rc.z_MGR-12-b.sh
#!  9808 Lines / 463 KB
#!===================================================
#! basic Date-of-Birth of this revised version. 
#!===================================================
gxMgr=0 #! author signature
[ ${gxMgr} = 0 ] && gxMgr="-gae"
#!===================================================
export gcMgr_SysDob="251216-1213"	    #! 
#!===================================================
export gcMgr_SysDob="${gcMgr_SysDob}${gxMgr}"
#!
export gcMgrLoc="/initrd/mnt/dev_save/MY_/usr-share/My_Dev_/Edit_MGR/rc.z_MGR-12-b.sh"
export gcMGRname="Manager" 
export gcMgrDevId="MGR"  
#!
export gcSysNameBase="MGR"  #: system label
export gcMgrVer="12"        #! "v:#" 
export gcMgrVerExt=".4"    #! sub-label: current dev is GTK NoteBook combined with BASH pages . 
#!
#(: ===================================================================== =======
#(: NOTE: 
...
#(: 
#(:  rc.z_MGR.sh  TXN minimized 
#(:  Main GUI code "page" method is user selectable.
...
#(:       and is compatible with DebBookWorm via "PEX" code.
...
export gcMgr_SysDob="${gcMgrNameBase_All}--${gcMgr_SysDob}-"	#! update so unique to each Build. 
...
export gcDistro01="#! BionicPup32-19.03-K5.9---K:5__32 __231209"
...
export gcDistro05="#! PEX-N64 _EX-Nobel____________________251008"
export gcDistro06="#! Trixie64-Legacy  K:6.12.43 _____________250917"
#!
export gcDistro07="#! DebBookwormPup32-10.0.7__231101____220227"
...
export gcDistro13="#! UPupFF+D-20.12+4_Focal-Fossa________201210"
export gcDistro14="#! KineticPup32-22.10+2__________________230604"
export gcDistro15="#! Slacko-7.0_DpupS7_14.2________________220205"
export gcDistro16="#! Xenial-64_7.5_XL________________________220401"
export gcDistro17="#! S15Pup-64_22.12+1-T___________________220922"
export gcDistro18="#! Quirky_April-7.0.1F-uefi_________________200511"
export gcDistro19="#! devuanpup-9.7.0-chimaera_4.0_i386____211206"
export gcDistro20="#! LxPupSc-slacko-20.01+0-T-k64__________200129"
export gcDistro21="#! slacko64_14.2_32-674-bit_comptible____220227"
export gcDistro22="#! NoblePup64-10.0-__K:huge.____________240220"
#!
#!pup_EX-Dev64-SDA plus N64N _
#! ######################################################################################
#!
...
#! example ID : "B4B", "B5B", "B64B", "N32N", "N64N", "T-6" is extracted from PUPSAVE .
export  gcMgrDevSubId="`echo -n "$PUPSAVE" | cut -f 3 -d '-'`"
#~ #! *********************************************************
#~ #! gcMgrVerAll req if MAIN RUNNING Terminal Screen 
...
function Sbr_Sys_CalcRamObj() {     #! req modularity
    #! "top=RamObj ==============================================="
    #! dev: "calc" if [ zero ]  for "${gcPupRamObjMsg}"
    if [ "${gcPupRamObjMsg}" ] ; then  # NOT ZERO   # do nothing
         n="0"
...
#!
export gcMrgBit32="1"       #!
export gcDistroReboot="wmreboot"    #! must be experiment in each Distro
#!
export gcMgrPuppyDate="${DISTRO_PUPPYDATE}"  
#!
#~ export gcDistroEOL=""   #! End-Of-Life          Not Used
...
#! =======================================================================================
		...
		#! required to control PEX OS "reboot" "poweroff" hangups. ***
		#! required to control PEX OS "reboot" "poweroff" hangups. ***
        #! PEX has "hang" during "ReBoot" and "PowerOff", 
        #! this control captures "ReBoot" and "PowerOff" , changes into "ReStart"  
        #! thereby, pushes execution of "reboot" and "poweroff" out to the PEX system. 
        #!
		#! control <button> <menu> :  true = control is Active
		export gcSysChkBtnFlg="true"		#! default  page_BackUp then ReStart/ReQuit/PowerOff
		export gcSysChkMnxFlg="false"        #! default  page_System primary <Exit> prg
		export gcSysChkPexFlg="false"       #! default  calls to Sbr_Cbx_ReBoot/PowerOff
        export gcSysChkTtlFlg="true"		#! default  Title is HomoGeneous page_System title line
		#! *****************************************************
        #!
        #!
#! #####################################################################
...
#! ===*=================================================================
       "BionicPup32" )      
            ...
            if [ "${DISTRO_PUPPYDATE}" = "Dec 2021" ] ; then  
                export gcMgrDistroKey="B4B21"
                export gcMgrDistroSymbol="B4B-21"  #! ":Kernal:4"  B4B21
...
#! ===*=================================================================
       "NoblePup32")    #! Noble v:6 + v:7 upgraded, and v:8 is being tested.
            ...
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
				...
				export lcOsSubDef="4" 
				#~ export lcOsSubId="Nobel32"
				export gxcMgrArCfgIdd="Nobel32"
				export lcOsSubDir="pup_UpupN32-SDA"
				export lcOsSubFn="/mnt/home/menu.lstNobel8"
...
#! ===*=================================================================
       "JammyPup32")        
            export gcMgrDistroKey="J5J"
            export gcMgrDistroSymbol="J5J"
			export gcSysChkBtnFlg="true"		#! <button> visible=" "  
            export gcSysChkMnxFlg="true"		#! <menu> visible=" "   
            export gcSysChkPexFlg="false"		#! <Pex>  is PEX OS     
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
...
#! ===*=================================================================
        "UPupFF+D")
            export gcMgrDistroKey="FF"
            export gcMgrDistroSymbol="F-F"
			export gcSysChkBtnFlg="true"		#! <button> visible=" "  
            export gcSysChkMnxFlg="true"		#! <menu> visible=" "   
            export gcSysChkPexFlg="false"		#! <Pex>  is PEX OS     
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
...
#!
		...
		"NoblePup64")
            ...
            export gcMgrDistroKey="PN64"
            export gcMgrDistroSymbol="_PN64_"  #! on sys tem screen 
            #! control 
			export gcSysChkBtnFlg="true"		#! <button> visible="0" NoblePup64
            export gcSysChkMnxFlg="0"			#! <menu> visible="0"   NoblePup64
            export gcSysChkPexFlg="true"		#! <Pex>  is PEX    NoblePup64
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
            export gcMrgBit32="1" 
            export gcMrgGuiWid="1100"   
...
#! ===*=================================================================
#!
#! ===* === menu 45 === DebBW64 === NOT PEX DISTRO =====================
#! ===* NOT PEX DISTRO ===
#! ===*=================================================================

		"BookwormPup64")

            export gcMgrDistroKey="DBW64"
            export gcMgrDistroSymbol="DebianBW-64"	            #! DBW64

            #! control 
			export gcSysChkBtnFlg="true"		#! <button> visible="1"  DBW64
            export gcSysChkMnxFlg="0"			#! <menu> visible="0"   DBW64
            export gcSysChkPexFlg="true"		#! <Pex>  is PEX OS     
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
            #! BUILD_FROM_WOOF='testing;a07eeb774;2025-05-18 17:19:42 +0100'
...
#!  DISTRO_NAME='puppex_dev'    PEX Devuan 64
		...
		"puppex_dev")
            ...
            export gcMgrDistroKey="PDV64"
            export gcMgrDistroSymbol="PEX-Devuan64"  			 #! on system screen 

            #! control 
			export gcSysChkBtnFlg="0"			#! <button> visible="0" 	puppex_dev	{PEX-Dev64}
            export gcSysChkMnxFlg="0"			#! <menu> visible="0"   	puppex_dev	{PEX-Dev64}
            export gcSysChkPexFlg="true"		#! <Pex>  is PEX OS     	puppex_dev	{PEX-Dev64}
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
...
#! ===* === menu 47 === PEX-N64 ==========================================
			...
			#! PUPSTATE has this:
			#! PSUBDIR='/pup_PEX-Dev64-SDA'
			#! "PEX-N64-SDA")	#! PEX Nobel 64   #! PEX-N640
...
#! ===* === menu === PexN640 =====================================================
		...
		"PEX_NoblePup64")
            ...
            export gcSysChkMnxFlg="false"		#! <menu> not visible="0"   NoblePup64
            export gcSysChkPexFlg="true"		#! <Pex>  is PEX OS     NoblePup64
            export gcSysChkTtlFlg="false"		#! <Ttl> Title is Not HomoGeneous
            export gcMrgBit32="1" 
            export gcMrgGuiWid="1100"   
...
#!
#! ===* === menu 48 === Trx64 =======================================================
#! pup_Trx64_SDA	    Legacy  Trixie pup 64 
#! PSUBDIR='/pup_Trx64_SDA'
#! DISTRO_NAME='TrixiePup64 Legacy'
#!

		"TrixiePup64 Legacy")
    
            export gcMgrDistroKey="PT64"
            export gcMgrDistroSymbol="{Trixie64}"  #! on system screen 
            #! control 
			export gcSysChkBtnFlg="true"		#! <button> visible="1" 	trixiepup64
            export gcSysChkMnxFlg="false"		#! <menu> visible="0"   	trixiepup64
            export gcSysChkPexFlg="false"		#! <Pex> this is PEX        trixiepup64
            export gcSysChkTtlFlg="true"		#! <Ttl> Title is HomoGeneous
			#!
			export gcMgrIsoDate="iso_TrixiePup64_Legacy-11.1.1_251028"   #!
			export gcMgrPuppyDate="${daedalus}"
            export gcMrgBit32="0" 
            export gcMrgGuiWid="1100"   
...
#! ===*=== END of Distro OS Testing ==============================================================
  
           *)       #! End of Normal Distro OS testing:   default 
  
            export gcMgrDistroKey="XXX"
            ...
            gcMrgBit32="0"     
            gcMrgGuiWid="1100"   
			lcOsSubDef="0"   # default "top" position-selection in "menu.lst"  
			lcOsSubTout="- # Generic 'ORGinal' has no timeout ."   
			
			lcOsSubId="ARB"     #! default to full menu format. 
...
#~ export gcBootOsHd="L1T"         # OS Hard-Drive, required in menu.lst build
...
#(: sends:
#(: rationale:
#(: note : normally is not sent.  not "0" , not "1", just not sent .
#(: note : if "opt" is ""  then  splash will linger until kill ! 
#(: fx====== Sbr_Splash code must be at top ==========================
#! #########################################################
...
lcMsgStr="
      ionice -c 1 snapmergepuppy  ()
         "
    echo "${lcMsgStr}"
    Sbr_Splash_It "${lcMsgStr}" "lightgreen" "purple" "2" "" #! & sleep 1
#!
#! ===================================================================
#! begin: Sbr_Sys_SMP
#!
#! from asktosave_session  
...
#! This is Sbr_Sys_SMP ========================
    ...
    sleep 1
    #~ Sbr_Splash_It ": DONE: Sbr_Sys_SMP :"  "yellow" "purple"  "2"          #! -D---
} # end: Sbr_Sys_SMP
...
#(: purpose: 
#(: calls:
#(: method: #! code copied from "PEXTon" save2flash process
#(: sends:
#(: rationale: several PEXton Distros are in my Installed OS for testing. 
#(: note :
#! #################################################################################
...
#(: Standard Menu System Selection Headers: 
    ...
    echo " #  reboot			#! this can make KLM bootable dongle to be a PassKey Device."
...
#(: pup_UpupN32-SDA
        echo "title  4 {[=_N32N_=]}---< N32N >----------K:Huge- 241101  \n  \n   \n"
        echo "  root (hd0,0)"
...
#(: pup_DpupBW64-12-SDA
        ...
        echo "title  5 { _DBW64_10.0.12_ }-< Debian Book-Worm 64 >-K:6 _25-Oct-01  \n   \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd    /MARK-${gcBootOsHd}"
...
#(: pup_dpupBW32-SDA
        ...
        echo "title 20 {==_DBW32_==}- Dpup-BW-32     - Debian BW--K:6 _32- 231119 \n   \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd    /MARK-${gcBootOsHd}"
...
#(: pup_UpupN64-SDA
        ...
        echo "title 21   {[-Nobel_N64N_]}---< Noble-Numbat 10.0 _ k:6.1.15>-----  \n  \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd   /MARK-${gcBootOsHd}"
...
#(: pup_Devuan-SDA
        echo "# #####################################{ Dev9 }"
        echo "title 22/X { Devuan 9.7.0-chimaera_4.0 }--- Devuan ---beta--------------    \n   \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd    /MARK-${gcBootOsHd}"
...
#(: pup_DpupBW64-12
        echo "##################################{ Debian Book Worm 64 10.0.12   K:6 64bit }"
        echo "title  25 {[_DBW64_10.0.12_]}-< DebBookWorm 64 10.0.12>---K:6 _25-Oct-01  \n   \n   \n"
        echo "  root (hd0,0)"
        echo "#!"
...
#!  Any Other Puppy Distro Calls can be listed without Numbers. 
        #!
} #! simple fall back to Sbr_Menu_Init. 
...
#! ===Build_Menu.lst_=======================================================
#(: fx================================================================================
#(: fx Sbr_Menu_Special_End    #! ACTIVE
#(: called by: Menu Echo Short and Long 
#(: param: 
#(: purpose: Standard Menu End , both Short and Long 
#(: calls:
...
#! method: echo Standard  ""Short and "Long" Menu.lst file output. 
#! #############################################################################
function Sbr_Menu_Special_End() {  #! controls  PEX and Special OS     # ACTIVE  
#(: fx Sbr_Menu_Special_End   #! Menu-Special  Menu_Special  Menu Special

        #~ echo  "#!"
        #~ echo  "#! fx Sbr_Menu_Special_End   #! Menu-Special  Menu_Special  Menu Special"
        #~ echo  "#!"
        echo "title fx Sbr_Menu_Special_End   #! Menu-Special  Menu_Special   \n  \n  \n "
        echo "	root (hd0,0)"

#~ #(: pup_UpupB4B-SDA
        echo "###################################{ Bionic 4 Beaver  K:4 32bit }"
        echo "title  43 {[=_B-4-B_==]}---< UpupBB-K:4.9  > ------------K:4_32--220407 \n  \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd   /MARK-${gcBootOsHd}"
        echo "  kernel /pup_UpupB4B-${gcBootOsHd}/vmlinuz    psubdir=/pup_UpupB4B-${gcBootOsHd} pmedia=usbflash pfix=fsck,copy"
        echo "  initrd /pup_UpupB4B-${gcBootOsHd}/initrd.gz"
        echo  "#!"
...
#~ #(: pup_Upupb64B-SDA
        echo "###################################{ Bionic Beaver    K:4 64bit }"
        echo "title  44 {[=_B-64-B_=]}---< UpupB64B-K:6 > -------------K:4_64- 231219   \n   \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd   /MARK-${gcBootOsHd}"
        echo "  kernel /pup_UpupB64B-${gcBootOsHd}/vmlinuz    psubdir=/pup_UpupB64B-${gcBootOsHd} pmedia=usbflash pfix=fsck,copy"
        echo "  initrd /pup_UpupB64B-${gcBootOsHd}/initrd.gz"
        echo  "#!"
...
#(: pup_PEX-Dev64-SDA
        ...
        echo "title  46 {[_pup_PEX-Dev64_]}-< ARB_PDV640 >-K:6 _25-Oct-14  \n   \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd    /MARK-${gcBootOsHd}"
...
#(: pup_PEX-N64-SDA
        #! ### L3 ### menu-special ##########################################################
        echo "##################################{ Puppy EX Nobel 64 K:6 64bit }"   
        echo "title  47 {[_pup_PEX-N64_]}-< pup_PEX-N64 >-K:6.6.14 _25-Oct-14  \n   \n   \n"
        echo "  find --set-root --ignore-floppies --ignore-cd    /MARK-${gcBootOsHd}"
...
#(: pup_PTrixie_64L-SDA    Legacy
        #! ### L4 ### menu-special ##########################################################
        echo "###################################{ PTrixie64L --- Legacy }"
        echo "title  48 {[_PEX-Trixie-64L_]}---< Trixie-64 Legacy > ----K:   -    \n   \n   \n"
        echo  "  find --set-root --ignore-floppies --ignore-cd   /MARK-${gcBootOsHd}"
        echo  "  kernel /pup_PTrixie64L-${gcBootOsHd}/vmlinuz    psubdir=/pup_PTrixie64L-${gcBootOsHd} pmedia=usbflash pfix=fsck,copy"
        echo  "  initrd /pup_PTrixie64L-${gcBootOsHd}/initrd.gz"
        echo  "#!"
#! ##############################################################################
    echo "################################{ Jump Menu : if file found, then boot"
	echo "title  49 { ${gcBootOsHd} to KLM1 } --- JUMP to --- /MARK-KLM1   === on { KLM1 } -------"
    echo "  find --set-root --ignore-floppies --ignore-cd /MARK-KLM1  && configfile /menu.lst"
    echo "  reboot"
    echo "################################{ Jump Menu : if file found, then boot"
	echo "title  50 { ${gcBootOsHd} to KLM2 } --- JUMP to --- /MARK-KLM2   === on { KLM2 } -------"
    echo "  find --set-root --ignore-floppies --ignore-cd /MARK-KLM2  && configfile /menu.lst"
    echo "  reboot"
        #! ### L3 #############################################################
        echo "######################################################################"
...
export -f Sbr_Menu_Special_End
#!
#! ===Build_Menu.lst_=======================================================
#! ===Build_Menu.lst_=======================================================
#!
#(: fx===========================================================
#(: fx Sbr_Menu_Init   #: Active
#(: called by: main gui 
...
#! #######################################################################################
function Sbr_Menu_Init() {  #! Fall-Thru: INITZ  before real Write Menu.lst    # ACTIVE      
    #! Standard Menu Standard Menu Short List
       ...
       #! Sbr_Menu_Init sends parameters to trigger one specific OS. 
       #!
...
#! #####################################################################            
           ...
           "ARB_PDV640")   lcOsSubDef="46"  ;;
           "ARB_PN640")    lcOsSubDef="47"  ;;
           "ARB_Trx640")   lcOsSubDef="48"  ;;
#! #####################################################################            
           "ARB_KLM1")     lcOsSubDef="49"  ;;
           "ARB_KLM2")     lcOsSubDef="50"  ;;
            *)             lcOsSubDef="49"  
        esac
#! #####################################################################            
        #!
    ...
    echo "${lcOsSubId}" > "${gcMgrArbCfgFn}" # gcMgrArCfgIdd "menu config"
        ...
        Sbr_Splash_It ": Writing: $EXIT at # ${lcOsSubDef}:" "yellow" "red" "3" ""
        #! this is a splash-n-wait ,  kill is later 
        #! kill ${GTKPID_Cold_Splash}  2>/dev/null
        #-----------------------------------------------------------------------
        #-----------------------------------------------------------------------
	#! ===Build_Menu.lst_=========================================
...
#(:  therefodre Cbx_( ReBoot and Halt ) should test for "PEX" flag, call ReStart. 
#(:
...
#!
    ...
    #! ############################################################
        ...
        #! Button "B-4-B" Svg
        ##############################################################################
        lcEmGrImgSrc="/tmp/EmGr-img-button-menu_B4B.svg"
        echo "################################## " >> ${gcEmGaImgFnTrgTxtMaster}   # title for "Dump" to screen
        echo "EmGr-img-button-text.svg" >> ${gcEmGaImgFnTrgTxtMaster}   # name of image
        echo "${lcEmGrImg}" >> ${gcEmGaImgFnTrgTxtMaster}   # title for "Dump" to screen
        echo '<?xml version="1.0" encoding="UTF-8"?>
...
Main BackUp  ! 
(1) ColdTarBackup_+_ReStart 
(2) ColdTarBackup_+_ReBoot
(3) ColdTarBackup_+_PwrOff 
-----------------------------------------------------------------"
#! ###################################################################### msg_DC_LxgenBack_window
...
* CBXC3C * Clear FireFox Caches for Puppy Linux !  .
...
!
! MGR 12  utilizes TWO different main GUI code methods, 
...
visible="true" ><frame>
<text editable="false" use-markup="true" xalign=".5"><label> "'${msg_DC_M12_window_text}'" </label></text>
<hbox>
    <button>
...
msg_DC_LxgenBASH_window_text="===_Page_SYSTEM_==="
...
<vbox>
    ...
    <hbox space="1" visible="1">
        ...
        <text>  <label> ':' </label></text>
        <text visible="0" use-markup="true" xalign=".5"  x="BASH">
            <label> "<span color='"'$lcGuiColorbrn'"'> <b>'${gcPupRamObjMsg}'</b></span>"</label></text>
        <text>  <label> ':' </label></text>
        <text use-markup="true" xalign=".5" x="BASH">
        ...
        <hseparator width-request="1"></hseparator> 
        <text visible="true">   <label>"'###_Single-Click_###'"</label> </text> 
        <hseparator width-request="1"></hseparator> 
        <vseparator height-request="13"></vseparator>
        <hbox homogeneous="true">
        ...
        <hbox homogeneous="1">
            ...
            <button tooltip-text="-One-PCB-ALL-" has-focus="true" height-request="32"> 
               <label>"'{{-One-PCB-All-}}'"</label>
               <action>'EXIT:guiArcOnePxbAll'</action> </button>
            <button  visible="0"   tooltip-text="EXIT:guiMgrAllArcDts" 
                gtk-apply="true" has-focus="false" >
                <label> "'-ALL-===}}'" </label>
...
#!
#! =====================================================================
#! _BASH_=== page === pageM === pageMenu =============================== ACTIVE
#! =====================================================================
msg_DC_LxgenMenu_window_text="===_Page_Menu_==="
...
<text editable="false" use-markup="true" xalign=".5"><label> "<span color='"'red'"'> <b>'${msg_DC_LxgenMenu_window_text}'</b> </span> " </label></text>
    <vbox>
        ...
        <vbox  visible="1" homogeneous="true">
            ...
            <hbox visible="0" homogeneous="true">
                <button visible="1" tooltip-text="'check-Big_90'" >
                    <input file>"'/tmp/EmGr-img-Check-90-redXblu.svg'"</input><width>30</width><height>30</height>
                    <label>"''"</label> <action>'select-Big_90'</action>  
                    <action function="'launch'">     msg_DC_Check_90_Big_redXblu_window</action>
    ...
    <vbox>
        ...
        <vbox visible="1">
            <hbox homogeneous="true"><hbox>
                ...
                <button visible="1" tooltip-text="BASH" >
           ...
           <vseparator  visible="1" height-request="17" > </vseparator>
            ...
            <vbox>
                <button visible="0" label="'{_Dependencies_/root/my-applications_}'" has-focus="false" width-request="100" height-request="35"> 
...
function Sbr_ClearFlagsSystem() {   # ACTIVE    # at 3560
    ...
    n=0
    #! current in-use
    rm -f "${gcMGR_LockFile}"             2>&1>/dev/null  ### this is "MGR_LockFile" ###  but not E3R  CBX
    #! tmp usage
...
function Sbr_Cbx_ReStart() {   # ACTIVE   Group:  "Sbr_Cbx_"
    ...
    sleep 1
    clear   #! Xterm debugging screen 
    #! This is "ReStart"   
    . ${0}      #: $ ZERO   # will run $0 / ReStart fresh .
    #!
    #! ELSE
    Sbr_FnNotFound " ${ 0 } ReStart"
    EXIT="" ### force "Fall Thru" if BASH call ${0} fails
    #!
} #
...
function Sbr_Cbx_ReBoot() {   # ACTIVE  Simple ReBoot 
    n=0
    #! gcMgrDistroKey in PDV64, PN64, PT64 . 
    if [ "${gcSysChkPexFlg}" = "true" ] ; then 	#! PEX is Active, OS does NOT handle ReBoot !
		n=0 #! PEX should only run ReStart
		Sbr_Splash_It "Cbx PEX ReSTART "  "yellow" "red" "5" #! -D!---
		Sbr_Cbx_ReStart
    else
		Sbr_Splash_It "Cbx S.I.M.P.L.E. _ReBoot "  "yellow" "green" "3" #! -D!---
		Sbr_ClearFlagsSystem  ""  #: clear lockfile, etc.
		Sbr_Sys_SMP      #! Sbr_Sys_SMP  #! Save-2-Flash 
		Sbr_Sys_Set_PEX	 #! setup the ReBoot wmreboot
...
function Sbr_Cbx_ReQuit() {   # ACTIVE   Simple rc.shutdown
    n=0
    #!	 || [ "${gcMgrDistroKey}" = "true" ]  ; then  #! OS does NOT handle "PowerOff" nor "Halt" properly !
    #! gcMgrDistroKey in PDV64, PN64, PT64 . 
    if [ "${gcSysChkPexFlg}" = "true" ] || [ "${gcMgrDistroKey}" = "true" ] ; then 	#! PEX is Active, OS does NOT handle ReBoot !
		n=0
		...
		Sbr_Splash_It "Cbx S.I.M.P.L.E. BASH poweroff / rc.shutdown "  "yellow" "green" "1" #! -D!---
		Sbr_ClearFlagsSystem  ""  #: clear lockfile, etc.
        Sbr_Sys_Set_PEX
		Sbr_Sys_SMP      #! Sbr_Sys_SMP  #! Save-2-Flash 

		/etc/rc.d/rc.shutdown	#! gae, 251202-2119
...
#(: rationale:
#(: note :
#(: PEX is Active, OS does NOT handle  "ReBoot / PowerOff / Halt" properly !
#(:  therefodre Cbx_ReBoot should test for "PEX" flag, call ReStart. 
#(:
#! ###_CBX_###  "Sbr_Cbx_RePowerOff" ##############################################
function Sbr_Cbx_RePowerOff() {   # NOT ACTIVE   Simple PowerOff
    n=0	#! PEX is Active, OS does NOT handle  "ReBoot / PowerOff / Halt" properly !
    #! gcMgrDistroKey in PDV64, PN64, PT64 . 
    if [ "${gcSysChkPexFlg}" = "true" ] || [ "${gcMgrDistroKey}" = "true" ]  ; then  #! OS does NOT handle "PowerOff" nor "Halt" properly !
		n-0
		Sbr_Splash_It "Cbx PEX PowerOff / ReSTART "  "yellow" "red" "5" #! -D!---
		Sbr_Cbx_ReStart
		#(:  "PEX" distros do not handle "ReBoot / PowerOff" properly, 
		#(:  therefodre Cbx_ReBoot should test for "PEX" flag, call ReStart. 
    else	#! Trix64L will hang on this, so must test for current OS = Trix64L
		Sbr_Splash_It "Cbx  S.I.M.P.L.E. BASH _PowerOff "  "yellow" "green" "1" #! -D!---
		Sbr_ClearFlagsSystem  ""  #: clear lockfile, etc. 
        Sbr_Sys_Set_PEX
		Sbr_Sys_SMP      #! Sbr_Sys_SMP  #! Save-2-Flash 
        poweroff   #! RePowerOFF___absolute_for_popping_stack___BASH_poweroff
    fi
    EXIT="" ### force "Fall Thru" if BASH call ${0} fails
    #!
} #
...
function Sbr_Cbx_ReHalt() {   # ACTIVE  Simple Absolute KILL system
    ...
    if [ "${gcSysChkPexFlg}" = "true" ] ; then  #! PEX is Active, OS does NOT handle ReBoot !
		...
		Sbr_ClearFlagsSystem  ""  #: clear lockfile, etc,  L:3551, L:4845
        Sbr_Sys_Set_PEX
		Sbr_Sys_SMP      #! Sbr_Sys_SMP  #! Save-2-Flash 
        halt
    fi
...
#~ #(:
#~ #! ###_CBX_################################################
#~ function Sbr_Cbx_Clear_Restart() {   #! NOT CALLED
    #~ #! for Check-Box ARB_ReHalt___  absolute_for_killing_stack ___ 
    #~ n=0
    #~ lcMsgStr="Cbx_Clear_Restart_"   #! NOT CALLED
    #~ Sbr_Splash_Flip3  ${lcMsgStr} ".3"  &&     sleep 1  #! NOT CALLED
    #~ #!
    #~ Sbr_ClearFlagsSystem 0      ### clear lockfile so that ReStart can run. #! NOT CALLED
    #~ Sbr_Cbx_ReStart 1    # display and no wait #! NOT CALLED
    #~ #! NOT CALLED
    #~ EXIT="" ### force "Fall Thru" if BASH call fails    #! NOT CALLED
    #~ exit 1      #! ## "exit 1' , error , should terminate this program quietly  #! NOT CALLED
#~ } #
#~ export -f Sbr_Cbx_Clear_Restart #! NOT CALLED
#!
#!
#!
#! #######################################################
...
function Sbr_Sys_SDA_Only() {    # ACTIVE
    ...
    #~ if [ ! -f "/initrd/mnt/dev_save/MARK-${gcBootOsHd}" ] || [ ! -f "/initrd/mnt/dev_save/MARK-L1T" ]; then  
    #~         /initrd/mnt/dev_save/MARK-L1T
    if [ ! -f "/initrd/mnt/dev_save/MARK-${gcBootOsHd}" ] ; then  
        #! if this HD is NOT the Primary Boot Drive. 
        #! if not Master HardDrive  ${gcBootOsHd} 
        Sbr_Splash_It "= Primary HD -ONLY --- $1 =" "yellow" "red"  "5"         #! -D---
        Sbr_Cbx_ReStart 1   ### Clean ReStart #  do not continue the called command.
    fi
    #! IF this is SDA1 or L1T, THEN OK to run 
...
<span background='brown'><span foreground='yellow'> '===================================='</span></span>
<b><span background='yellow'><span foreground='blue'> '#! Running Tests on 23+ live-active Puppy Linux OS'</span></span></b>
<span background='brown'><span foreground='yellow'> '====================================' </span></span>
<span foreground='red'>"-------------------------------------"</span>
...
Date-Version: ${gcMgr_SysDob}
Date-Now-Run: "`date +%y%m%d-%H%M-%S-%a`" 
Src:/sys/fs/aufs="`cat /sys/fs/aufs/si_*/br1 | head -1 | cut -f1 -d'='`"   RamObj: ${gcPupRamObjMsg}
=======================================
PUP_HOME: ${PUP_HOME}
: ${PUPSAVE}
...
* operating sys: `uname -o` 
*gcMgr_SysDob = ${gcMgr_SysDob}   *gcMgrDevId = ${gcMgrDevId} 
*gcSysDistroPuppySFS=${gcSysDistroPuppySFS}  
*gcPupSfsFile=${gcPupSfsFile}"
#!
#! -D---
touch  /tmp/box_help   
echo "${lcStrUpPop}" > /tmp/box_help
Sbr_Box_Message "=== Sbr_Box_Message > /tmp/box_help + box_help"
RETVAL=$?
#!
touch  /Sbr_Dump_Sys.txt
echo "${lcStrUpPop}" > /Sbr_Dump_Sys.txt
#!
} # 
...
#!
echo "================================ "   >> /tmp/Mgr_Dump_Declare-Var.txt  
echo "# end: Dump_Declare-Var.txt   ..."  >> /tmp/Mgr_Dump_Declare-Var.txt
echo "================================ "   >> /tmp/Mgr_Dump_Declare-Var.txt  
#!
clear
#!
...
<span foreground='purple'>"#! Each OS is original as written by Mik01,PeaBee,ect ."</span>
"---"
"--- iso list includes: "
<b><span foreground='"'red'"'>"${gcDistro01}"</span></b>
<b><span foreground='"'red'"'>"${gcDistro02}"</span></b>
...
*________________________________________________________________________________________" &
    ...
    lcFnTrg="/mnt/home/MY_/usr-share/My_Dev_/Edit_MGR/arc_Common_dts_/${lcSysArcFnSrc}${gcMgrVerExt}-${lcMgrArcDtsNow}.sh"
    #! ===============================================
    #!   
    echo  "!:  ${lcSysArcFnSrc}"
    echo  "fr: ${lcFnSrc}"
...
function Sbr_BakAllArcDts_One() {    #  ACTIVE   
    ...
    lcFnTrgRA="/root/my-applications/${lcSysRealFnSrc}"
    #! --- Sbr_BakAllArcDts_One
    if [ -f "${lcFnSrc}" ]  ; then 
/usr/lib/gtkdialog/box_splash -fg yellow -bg blue -border true -close never -text "\
...
" &    pidx=$!
    ...
    Sbr_BakAllArcDts_One "S2F"     "savePEXflash"         "${lcMntHomeSubDir}"
    Sbr_BakAllArcDts_One "S2F"     "S2F"                "${lcMntHomeSubDir}"
    Sbr_BakAllArcDts_One "S2F"     "sXf"                "${lcMntHomeSubDir}"
...
#! begin lock-file section ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    touch "${gcMGR_LockFile}"   # Always ! for "Soft Lock" 
    #(: clear this lockfile at end of "QUIT", bottom of code, natural clear.
    #! end: Sbr_LockFile
    #(:
    #(: 
...
#!
#!
#(: fx=== make this a function, call in main () ===============================
...
#(: fx================================================================
#;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
function PXB_Splash_Wait_mow() {   #! Big MAIN splash # ACTIVE : auth is "mow" : 
...
n=0    
########################################
export gcPxbSysDevDob="251031-1705"    #! added: puppex-dev64 ___ Pup-EXon-Dev64 code.
########################################
#
...
#!
#! --- MAIN () 
#! deprecate this config routine 
if [ -f ${gcMgrArbCfgFn} ] ; then   #! "menu config"  
    n=0
    gcMgrArbCfgFn="/root/my-applications/bin/C3M_Config_Arb"   # "menu config"
    gcMGRConfigArbIdd=`cat ${gcMgrArbCfgFn}`   #! "menu config"
else    #  NO Config value
    n=0
    touch ${gcMgrArbCfgFn}  #! "menu config"
    gcMGRConfigArbIdd="---" #! "menu config"  
fi  #
#! 
#! --- MAIN () 
...
#! --- MAIN () 
#!
#!   : Sbr_Sys_Case_PupMode 	#! if called then Sbr must precede . 
case $PUPMODE in
    12|13) ok=1 ;;  
    *) ERRORMSG="Not PupMode !  only (12|13) : will continue !" 
        ;;
esac
#!
#! --- MAIN () 
...
#! export lcGuiWindowTitle="?:${gcMgrDistroSymbol}:_:MGR:_::${lcGuiSplT3}::${gcSysIdFull}::${gcSysKernName}::${gcSysDevHw}::${gcMgr_SysDob}::${gcMgrVerExt}"
#! Secondary "Frame" title embeds OK.
export lcGuiFrameTitle=" v:${gcMgr_SysDob}:  ${gcMgrDevDesc} : "    
#!
#! export gcToolTip-Text="':${gcMgrDistroSymbol}:_:RamObj=${gcPupRamObjMsg}_:B=:${gcSysChkBtnFlg}_:M=${gcSysChkMnxFlg}_:P=${gcSysChkPexFlg}_:T=${gcSysChkTtlFlg}'" >
#!
...
#!  These are previous 'normal' settings for the GTK window.  Not Active. 
    ...
    #! border-width="3"
    #! resizable="true" 
#! used for MGR-11.3 NoteBook method. ### MAIN GUI ###
#! main_notebook
...
<button visible="1"   width-request="45" height-request="45"  size="medium"  weight="bold" 
   tooltip-text="" 
    ...
    <label>"'========================================================'"</label></text>
<vbox visible="1">
<hbox  x="Begin:NoteBook.where.does.hbox.end?" >
        <hseparator width-request="1"></hseparator> 
...
<label>"'##############################_Begin:_===_NoteBook_===################################'"</label> </text> 
    <vbox visible="1">
        ...
        <button  use-markup="true" has-focus="false" height-request="55" width-request="50" xalign=".5"  
            tooltip-text="':${gcMgrDistroSymbol}:${DISTRO_VERSION}:_:RamObj=${gcPupRamObjMsg}_:B=:${gcSysChkBtnFlg}_:M=${gcSysChkMnxFlg}_:P=${gcSysChkPexFlg}_:T=${gcSysChkTtlFlg}'" >
        ...
        <hbox visible="1">
          <hseparator  visible="1" height-request="3" width-request="55"></hseparator>
            ...
            <text xalign=".5">  <label> ':' </label></text>
            <text use-markup="true" xalign=".5">
                <label> "<span color='"'$lcGuiColorgrn'"'> <b>'K_:_${gcMGRKernVer}'</b> </span>" </label> </text>
            <text xalign=".5">  <label> ':' </label></text>
            <text visible="0" use-markup="true" width-request="12" x="NoteBook">
                <label>"<span color='"'$lcGuiColorbrn'"'><b>'${gcPupRamObjMsg}'</b></span>"</label></text>
        ...
        <hseparator width-request="1"></hseparator> 
        <hbox homogeneous="true">
            <button  visible="0" tooltip-text="-One-PCB-ALL-" has-focus="true" height-request="32"> 
               <label>"'One-PCB-All'"</label>
               <action>'EXIT:guiArcOnePxbAll'</action> </button>
        </hbox>
        ...
        <vbox>
           <hbox homogeneous="true">
            <button  visible="1" tooltip-text="-One-PCB-ALL-" has-focus="true" height-request="32"> 
               <label>"'{{-One-PCB-All-}}'"</label>
               <action>'EXIT:guiArcOnePxbAll'</action> </button>
           </hbox>
            <hbox>
            <button  visible="1"   tooltip-text="EXIT:guiMgrOneArcDts"  
                ...
                <label> "'{{===-ONE-'" </label>
                <action>'EXIT:guiMgrOneArcDts'</action>         </button>
            <button visible="1"  tooltip-text="EXIT:guiPXB_ion_ReStart" has-focus="false" height-request="13"  xalign=".5" > 
                <label> "'{{-PCB-}}'" </label>
                <action>'EXIT:guiPXB_ion_RS'</action>   </button>
            <button  visible="1"   tooltip-text="EXIT:guiMgrAllArcDts" 
                gtk-apply="true" has-focus="false" >
                <label> "'-ALL-===}}'" </label>
                <action>'EXIT:guiMgrAllArcDts'</action>   </button>
            </hbox>
    ...
    <vbox>
        ...
        <vseparator height-request="7"></vseparator>
        <button use-markup="true" has-focus="false" height-request="55" width-request="50" xalign=".5"  
tooltip-text="':${gcMgrDistroSymbol}:_:RamObj=${gcPupRamObjMsg}_:B=:${gcSysChkBtnFlg}_:M=${gcSysChkMnxFlg}_:P=${gcSysChkPexFlg}_:T=${gcSysChkTtlFlg}'" >
            <input file>"'/tmp/EmGr-img-button-menu.svg'"</input>
            <label> "" </label><action>'0---button-menu-svg'</action>  </button>
        <button visible="1" homogeneous="true" height-request="33" xalign=".5"  
            tooltip-text="''" >
            <label> "'---"'"_${gcMgrDistroSymbol}"'"_active_____"'"MENU"'"_Will_Over_Write_Existing_"'"menu.lst"'"_---'" </label>
        ...
        <vbox  visible="1" homogeneous="0">
            ...
            <hbox visible="true" homogeneous="true"><hbox>
                <button tooltip-text="''" >
                    <input file> "'/tmp/EmGr-img-jug-yelxred.svg'"</input><width>22</width><height>22</height>
                     <label>"''"</label> <action>'0'</action> </button>
                <hseparator width-request="42"></hseparator> 

                <button tooltip-text="'ARB_B4B-!:Pex=${gcSysChkPexFlg}:'"> <label>"'-B4B-!'"</label>
                    <input file>"'/tmp/EmGr-img-Check-90-redXyel.svg'"</input> <width>22</width><height>22</height>
                    <action>'EXIT:ARB_B4B'</action>  </button>

                <hseparator width-request="22"></hseparator>
    
                <button tooltip-text="'ARB_B64B-!:Pex=${gcSysChkPexFlg}:'"> <label>"'-B64B-!'"</label>
                    <input file>"'/tmp/EmGr-img-Check-90-redXyel.svg'"</input> <width>22</width><height>22</height>
                    <action>'EXIT:ARB_B64B'</action>  </button>
            ...
            <hbox homogeneous="true"><hbox>
                <hseparator width-request="1"></hseparator> 
                <button visible="1" tooltip-text="'N_check-Big_90:Pex=${gcSysChkPexFlg}:'" >
                    <input file>"'/tmp/EmGr-img-Check-90-redXyel.svg'"</input><width>33</width><height>33</height>
                        <label>"''"</label> <action>'select-Big_90'</action>
                    <action function="'launch'">     msg_DC_Check_90_Big_redXyel_window</action>
                    <action function="'closewindow'">msg_DC_Check_90_Big_redXyel_window</action>    </button>
                <hseparator width-request="12"></hseparator> 
                <button tooltip-text="'[1]_EXIT:ARB_DBW640__DebBookWorm64-v10.0.12_date:251001_:Pex=${gcSysChkPexFlg}:'" > <label>"'_DBW64_'" </label>
                ...
                <button tooltip-text="'[2]_EXIT:ARB_PDV640__Pup-EXtron-Devuan-64_:Pex=${gcSysChkPexFlg}:'" > <label>"'_PEX-Dev64_'" </label>
                        <input file> "'/tmp/EmGr-img-Check-90-redXgrn.svg'"</input><width>33</width><height>33</height>
                    <action>'EXIT:ARB_PDV640'</action>  </button>
                <hseparator width-request="4"></hseparator> 
                <button tooltip-text="'[3]_EXIT:ARB_PN640__Pup-EXtron-NOBLE-64_:Pex=${gcSysChkPexFlg}:'" > <label>"'_PEX-N64_'" </label>
                        <input file> "'/tmp/EmGr-img-Check-90-redXblu.svg'"</input><width>33</width><height>33</height>
                    <action>'EXIT:ARB_PN640'</action>  </button>
                <hseparator width-request="12"></hseparator> 
                <button  tooltip-text="'[4]_ARB_Trx640-Legacy_trixie_:Pex=${gcSysChkPexFlg}:'" > <label>"'_Trixie-640_'"</label>
                    <input file> "'/tmp/EmGr-img-Check-90-redXblu.svg'"</input><width>33</width><height>33</height>
                    <action>'EXIT:ARB_Trx640'</action>  </button>
                <hseparator width-request="4"></hseparator> 
               <button visible="1" tooltip-text="'check-Big_90'" >
                    <input file>"'/tmp/EmGr-img-Check-90-redXyel.svg'"</input><width>33</width><height>33</height>
                        <label>"''"</label> <action>'select-Big_90'</action> 
            ...
            <hbox visible="true" homogeneous="true"><hbox>
                <button tooltip-text="'check-Big_90'" >
                    ...
                    <action function="'closewindow'">msg_DC_Check_90_Big_redXgrn_window</action>    </button>
                <hseparator width-request="12"></hseparator> 
                <button tooltip-text="'ARB_B5B-!'"> <label>"'B5B-'"</label>
                    <input file> "'/tmp/EmGr-img-jug-redxblu.svg'"</input><width>15</width><height>15</height>
                    <action>'EXIT:ARB_B5B'</action>  </button>
                <button tooltip-text="'ARB_T-6-!'">  <label>"'T-60-'"</label>
                    <input file> "'/tmp/EmGr-img-jug-redxblu.svg'"</input><width>15</width><height>15</height>
                    <action>'EXIT:ARB_T-6'</action>  </button>
                <button tooltip-text="'ARB_N32N-!'"> <label>"'N32N-'" </label>
                    <input file> "'/tmp/EmGr-img-jug-redxblu.svg'"</input><width>15</width><height>15</height>
                    <action>'EXIT:ARB_N32N'</action>  </button>
                <button tooltip-text="'ARB_N64N-!'"> <label>"'N64N-'" </label>
                    <input file> "'/tmp/EmGr-img-jug-redxblu.svg'"</input><width>15</width><height>15</height>
                    <action>'EXIT:ARB_N64N'</action>  </button>
                <button tooltip-text="'ARB_ORG-!'"> <label>"'genORG-'" </label>
                    <input file stock="gtk-no"></input><width>7</width><height>7</height>   
                    <action>'EXIT:ARB_ORG'</action>  </button>
                <hseparator width-request="12"></hseparator> 
                <button tooltip-text="'check-Big_90'" >
            ...
            <hbox homogeneous="true"><hbox>
                <hseparator width-request="2"></hseparator> 
                <button tooltip-text="'[Boot]_Jump_to_KLM1_'" > <label>"'_KLM1_'" </label>
                        <input file> "'/tmp/EmGr-img-jug-yelxred.svg'"</input><width>33</width><height>33</height>
                    <action>'EXIT:ARB_KLM1'</action>  </button>
                <hseparator width-request="2"></hseparator> 
                <button tooltip-text="'[Boot]_Jump_to_KLM2_'" > <label>"'_KLM2_'" </label>
                        <input file> "'/tmp/EmGr-img-jug-yelxred.svg'"</input><width>33</width><height>33</height>
            ...
            <hbox homogeneous="true">
                <button  visible="1"   gtk-apply="true" has-focus="false" > 
                    <input file>"'/tmp/EmGr-img-Check-bluXblu.svg'"</input><width>"25"</width><height>"25"</height>
                    <label> " { 'MCI_Project_Instructional-Ext' }  " </label>
                    <action>'EXIT:guiMCI'</action>      </button>
            </hbox>
            <vseparator height-request="22"></vseparator>
...
tooltip-text="':${gcMgrDistroSymbol}:_:RamObj=${gcPupRamObjMsg}_:B=:${gcSysChkBtnFlg}_:M=${gcSysChkMnxFlg}_:P=${gcSysChkPexFlg}_:T=${gcSysChkTtlFlg}'" >
        ...
        <hseparator width-request="12"></hseparator> 
            ...
            <button visible="1"  tooltip-text="EXIT:guiPXB-RS"  
                has-focus="true" width-request="35" height-request="35" >
                <input file> "'/tmp/EmGr-img-jug-redxyel.svg'"</input><width>33</width><height>33</height>
                <label>"'*_PXB_BackUp_ReSTART_*'"</label>
                    <action>'EXIT:guiPXB-RS'</action>   </button>
            <vseparator height-request="3"></vseparator>
            <button visible="'${gcSysChkBtnFlg}'"  tooltip-text="EXIT:guiPXB-RB"  
                has-focus="true" width-request="55" height-request="35" >
                <input file> "'/tmp/EmGr-img-hash-red.xpm'"</input><width>33</width><height>33</height>
                <label>"'*_PXB_BackUp_ReBoot_*'"</label>
                    <action>'EXIT:guiPXB-RB'</action>   </button>
            <vseparator height-request="3"></vseparator>
            <button visible="'${gcSysChkBtnFlg}'"   tooltip-text="EXIT:guiPXB-RQ"  
                has-focus="true" width-request="55" height-request="35" >
                <input file> "'/tmp/EmGr-img-jug-redxgrn.svg'"</input><width>33</width><height>33</height>
                <label>"'*_PXB_BackUp_PowerOff_*'"</label>
                    <action>'EXIT:guiPXB-RQ'</action>   </button>
            <vseparator height-request="27"></vseparator>
            <hbox visible="1" homogeneous="false">
            <hbox homogeneous="0">
...
tooltip-text="':${gcMgrDistroSymbol}:_:RamObj=${gcPupRamObjMsg}_:B=:${gcSysChkBtnFlg}_:M=${gcSysChkMnxFlg}_:P=${gcSysChkPexFlg}_:T=${gcSysChkTtlFlg}'" >
        ...
        <hbox homogeneous="true"><hbox>
            <hseparator width-request="12"></hseparator>
            <button    tooltip-text="">
                <input file>"'/tmp/EmGr-img-Check-90-redXgrn.svg'"</input><width>15</width><height>15</height>   
                <label>'{-S2F-1-}'</label>
                <action>'EXIT:gui_S2F1'</action>  </button>
            <hseparator width-request="22"></hseparator>
            <button    tooltip-text="">
                <input file>"'/tmp/EmGr-img-Check-90-redXblu.svg'"</input><width>15</width><height>15</height>   
                <label>'{-PnMount-All-}'</label>
                <action>'EXIT:gui-P-MntInt'</action>  </button>
            <hseparator width-request="22"></hseparator>
            <button    tooltip-text="EXIT:guiPXB_ion_RS" >
                <input file>"'/tmp/EmGr-img-Check-90-redXyel.svg'"</input><width>15</width>  <height>15</height>
                <label> "'{-PCB-RS-Internal}'" </label>
                <action>'EXIT:guiPXB_ion_RS'</action></button>
            <hseparator width-request="22"></hseparator>
            <button    tooltip-text="">
                <input file>"'/tmp/EmGr-img-Check-90-redXblu.svg'"</input><width>15</width><height>15</height>   
                <label>'{-UnMount-All-}'</label>
                <action>'EXIT:gui-U-MntInt'</action>  </button>
            <hseparator width-request="12"></hseparator>
            <button    tooltip-text="">
                <input file>"'/tmp/EmGr-img-Check-90-redXgrn.svg'"</input><width>15</width><height>15</height>   
        ...
        <hbox homogeneous="true"><hbox>
            ...
            <button visible="1">  <label>" '/Edit' "</label>
                <action function="closewindow">msg_DC_LxgenDox_window_0</action>    </button>
            <hseparator width-request="12"></hseparator>
            <button    tooltip-text="/initrd/mnt/dev_save/MY_/usr-share/My_Dev_" >
...
<label>"'####################_End_NoteBook_############################'"</label> </text> 
	...
	<hbox homogeneous="true"><hbox>
            ...
            <button tooltip-text="'Enable_BASH_It_'" has-focus="false" width-request="0"  height-request="0" xalign=".5"  >
                ...
                <action function="'launch'">msg_DC_LxgenBASH_window_0</action> 
                <action function="'closewindow'">msg_DC_LxgenBASH_window_0</action>
                <action>'EXIT:guiSimReStart'</action> </button>
             <hseparator width-request="33"></hseparator>
            ...
            <button  visible="0" alt="${gcSysChkMnxFlg}" tooltip-text="S.I.M.P.L.E.__guiSimReBoot">    
                <input file>"'/tmp/EmGr-img-quit-rednnn.svg'"</input><width>15</width>  <height>15</height>
                <label>'_PowerOff_'</label>
                <action function="'launch'">msg_DC_Quick_window</action><action function="'closewindow'">msg_DC_Quick_window</action>
                <action>'EXIT:guiSimReQuit'</action> </button>
             <hseparator width-request="33"></hseparator>
            <button  visible="0"   tooltip-text="Test-Absolute-Fall-Thru">
                <input file>"'/tmp/EmGr-img-Check-90-redXgrn.svg'"</input><width>12</width><height>12</height>   
                <label>'{-EXIT="''"-}'</label>
                <action>'EXIT:""'</action>  </button>
            <hseparator   visible="0"  width-request="22"></hseparator>
	</hbox></hbox>
    </vbox>
...
#!
#(: fx====================================================================
#(: fx EXIT:C3CS2FRS   fx EXIT:C3CS2FRB   fx EXIT:C3CS2FRQ      # Active   
...
#!
#! ==================================================================================
if [ $EXIT = "C3CS2FRS" ] || [ $EXIT = "C3CS2FRB" ] || [ $EXIT = "C3CS2FRQ" ]   ; then        #! 250714-1700, 251013-0736 gae
        #!
...
#(:
#! #########################################################
if [ "$EXIT" = "gui-P-MntInt" ]  ; then    # ACTIVE
    n=0
...
#(:
#! #########################################################
if [ "$EXIT" = "gui-U-MntInt" ]  ; then    # ACTIVE
    n=0
...
#(:
#! #####################################################
if [ "$EXIT" = "guiDumpDeclareSys" ] ; then   #  Dump System  ACTIVE
    n=0
...
#(:
#! #####################################################
if [ "$EXIT" = "guiDumpDeclareVar" ] ; then   #  Dump System  ACTIVE
    n=0
...
#!
#! ###########################################################
#(: fx=== begin: page 3 : Util can call external programs 
#! ###########################################################
#!
#!
#(: fx========================================================
...
#! #################################################################################
if [ "$EXIT" = "guiPXB-RS" ] || [ "$EXIT" = "guiPXB-RB" ] || [ "$EXIT" = "guiPXB-RQ" ]  || [ "$EXIT" = "guiPXB-PO" ] ; then   
    n=0
    Sbr_Splash_It "=== ${EXIT} ===" "yellow" "green" "3"  
        Sbr_Sys_KillProc  
        Sbr_ClearFlagsSystem 0      ### clear lockfile so that ReStart can run.
        #!
		Sbr_PXB_INT		#! PXB_INT must control BtnFlg 
    ...
    if [ "$EXIT" = "guiPXB-RB" ] ; then   
		...
		EXIT="" ### force "Fall Thru" if BASH call fails
		exit 1  #! ## "exit 0' should terminate this program quietly.
    fi
    #!### #5 ### PXB ReQuit ###################################
...
#!
#! ========================================================
#(: fx=== end: Page3=== UTIL can call to external programs
#! ========================================================
#!
#!
#!   Fall-Thru Method 
...
if [ "$EXIT" = "guiSimReStart" ]  ; then  
    ...
    EXIT="" ### force "Fall Thru" if BASH call fails
    exit 0  #! ## "exit 0' should terminate this program quietly.
fi  #  guiSimReStart
#!
#!
#(: fx=================================================
#(: fx EXIT:guiSimReQuit
#(: fx=================================================
...
#!
#!
#(: fx==== EXIT:ARB_ORG was "Generic" for "Original-Long-List" ==============================
...
#! ====================================================
#! BEGIN:  Menu Built   IF/FI  [ "$EXIT" = "ARB_00"  ] || [ "$EXIT" = "ARB_ORG"  ] \
#! ====================================================
...
|| [ "$EXIT" = "ARB_B4B0"  ] || [ "$EXIT" = "ARB_B5B0" ] \
|| [ "$EXIT" = "ARB_B4B0" ]  \
|| [ "$EXIT" = "ARB_KLM1"  ] || [ "$EXIT" = "ARB_KLM2" ]   ; then
#!
#! if menu selected is in valid list, then call Sbr_Menu_Init
    n=0
    Sbr_Splash_It "[]  call Menu_Init  []" "yellow" "green" "2"  
    Sbr_Sys_SDA_Only ": SDA Menu" # control: test "SDA" else  ReStart
    Sbr_Sys_KillProc   
    #!
    echo "${lcOsSubId}" > "${gcMgrArbCfgFn}" # gcMgrArCfgIdd "menu config" #! Not Used 
    Sbr_Menu_Init    #! Build Menu permission/config control #! calls all Build Menu Routines. 
	#!
    export gcC3MConfigArbId="${gcC3MConfigArbId}"
    echo "${gcMgrArCfgIdd}" > "${gcMgrArbCfgFn}"  # "menu config"
	#!
	#! All Build Menu Code returns here: end of Build Menu  IF/FI .
	#! Sbr_Cbx_ReStart 1
    Sbr_Cbx_ReBoot   #! Standard ReBoot so to load New System and the "new menu.lst"
    #!
else
	n=0
...
if [ "$EXIT" = "guiMainQUIT" ]  ; then
    n=0
    #! must clear two times because of active XTerm screen data. 
...
#! ############################################################
    ...
    Sbr_Splash_Pup  
    lcMsgStrwc=$(wc -l < ${0})
    lcMsgStr="$lcMsgStrwc lines.  ---DOB:${gcMgr_SysDob}---"
    Sbr_Str2DevTrm "$0  has  $lcMsgStr " "1" "1"
    lcMsgStr="->->->  Standard QUIT Process " && Sbr_Str2DevTrm "${lcMsgStr}" "3" "0"
